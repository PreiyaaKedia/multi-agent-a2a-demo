...
async def run_expense_reimbursement_agent_example():
    """Example of running the ReimbursementAgent."""
    agent = ReimbursementAgent()
    session_id='test_session_1'

    async for response in agent.stream(
        'I would like to request a reimbursement of $50 for a team lunch.',
        session_id=session_id,
    ):
...
if __name__ == '__main__':
    ...
    asyncio.run(run_expense_reimbursement_agent_example())